...
FIRMIR_EXPORT_SYMBOL std::ostream &operator<<(std::ostream &os, Firmir::DBus::Connection::State state);
FIRMIR_EXPORT_SYMBOL std::ostream &operator<<(std::ostream &os, Firmir::DBus::Connection::Type type);
